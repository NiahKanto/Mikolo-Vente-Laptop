        ...
        <?php 
            for($i=0;$i<count($liste);$i++){?>
              <tr>
                    ...
                    <td><?php echo($liste[$i]->daterenvoi);?></td>
    ...
    <div class="modal modal-search fade" id="modif" tabindex="-1" role="dialog" aria-labelledby="modif" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form method="get" action="<?php echo url('/receptionRenvoi'); ?>" >
            <input hidden name="idrenvoi" id="idrenvoi" type="text" required/>
             Entrez quantite :        
  ...
  <script src="assets/demo/demo.js"></script>
    ...
    <script type="text/javascript">
        ...
        function setId(id,intitule){
            val1=document.getElementById("idrenvoi");
            val1.value=id;
