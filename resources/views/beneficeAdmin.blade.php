...
<div class="logo">
    ...
    <div class="content">
    <div class="col-12">
    <a href="/pdfvente?type=1&string=<?php echo ($string);?>" ><button class="btn" >Generer PDF</button></a>
        ...
        <?php 
            for($i=0;$i<count($liste);$i++){?>
              <tr>
                  ...
                  <td><div style="background-color:<?php echo ($liste[$i]->getCouleur())?>;"><a href="/detail?mois=<?php echo($liste[$i]->mois) ?>&annee=<?php echo($liste[$i]->annee) ?>" ><?php echo($liste[$i]->montant);?></a></div></td>
                  <td><?php echo($liste[$i]->montantachat);?></td>
                  <td><?php echo($liste[$i]->getBeneficeBrute());?></td>
                  <td><?php echo($liste[$i]->getPerte());?></td>
                  <td><?php echo($liste[$i]->getApresPerte());?></td>
                  <td><?php echo($liste[$i]->getMontantCommission());?></td>
                  <td><?php echo($liste[$i]->getApresCommission());?></td>
              </tr>
            <?php }
        ?>
