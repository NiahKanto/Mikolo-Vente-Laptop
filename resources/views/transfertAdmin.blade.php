...
<div class="logo">
    ...
    <button class="btn" data-toggle="modal" data-target="#nouveau">Nouveau transfert</button>
    <div class="modal modal-search fade" id="nouveau" tabindex="-1" role="dialog" aria-labelledby="nouveau" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form method="get"  action="<?php echo url('/insertionTransfert'); ?>" >
            Choisissez point de vente: <select class="form-control" name="idpointvente">
                    <?php 
            ...
            Choisissez la reference : <select class="form-control" name="idreference">
             ...
             Entrez quantite :        
                    <input name="qte" type="number" required/><br>

                    Entrez la date du transfert :        
