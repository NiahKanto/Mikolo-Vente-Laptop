...
<div class="logo">
        ...
        <?php 
            for($i=0;$i<count($liste);$i++){?>
              <tr>
                  ...
                  <td><button class="btn btn-info" data-toggle="modal" data-target="#modif" onClick="setId('<?php echo ($liste[$i]->id) ?>','<?php echo ($liste[$i]->lieu) ?>')" ><i class="tim-icons icon-pencil"></i></button></td>
      ...
      <div class="modal modal-search fade" id="sup{{ $i }}" tabindex="-1" role="dialog" aria-labelledby="nouveau" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            Etes-vous sur de supprimer ce point de vente?
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i class="tim-icons icon-simple-remove"></i>
              </button>
            </div>
            <a href="/suppressionPointVente?id=<?php echo ($liste[$i]->id)?>"><button class="btn btn-danger" >OUI</button></a>
          </div>
        </div>
      </div>
              </tr>
    ...
    <div class="modal modal-search fade" id="nouveau" tabindex="-1" role="dialog" aria-labelledby="nouveau" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            Insertion PointVente
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i class="tim-icons icon-simple-remove"></i>
              </button>
            </div>
            <form method="get"  action="<?php echo url('/insertionPointVente'); ?>" >
             Entrez le lieu :        
      ...
      <div class="modal modal-search fade" id="modif" tabindex="-1" role="dialog" aria-labelledby="modif" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            Modification PointVente
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i class="tim-icons icon-simple-remove"></i>
              </button>
            </div>
            <form method="get" action="<?php echo url('/modifierPointVente'); ?>" >
            <input hidden name="idPointVente" id="pointvente" type="text" required/>
             Entrez le lieu :        
                    <input id="lieu" name="lieu" type="text" required/><br>
...
<script src="assets/js/core/jquery.min.js"></script>
  ...
  <script src="assets/demo/demo.js"></script>
    ...
    <script type="text/javascript">
        ...
        function setId(id,lieu){
            val1=document.getElementById("pointvente");
            val1.value=id;
            val2=document.getElementById("lieu");
            val2.value=lieu;
        }
    </script>
</body>
